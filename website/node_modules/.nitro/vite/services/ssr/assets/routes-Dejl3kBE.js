...
import { ArrowRight, Bell, Check, ChevronRight, Facebook, HeartPulse, Instagram, Leaf, Linkedin, ScanLine, Send, Sparkles, Star } from "lucide-react";
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: [
							...
							3,
							4
						].map((i) => /* @__PURE__ */ jsx(Star, { className: "h-3.5 w-3.5 fill-primary text-primary" }, i))
					}), /* @__PURE__ */ jsx("span", { children: "Loved by 2,400+ plant parents on the waitlist" })]
				}),
